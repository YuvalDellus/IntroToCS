...
def quadratic_equation_user_input():
    ...
    """takes input from the user and return how many roots to the equation and there value"""

    raw_input = input(ENTER_COEFFICIENTS_MESSAGE)
    a,b,c = raw_input.split()  # split the input to different variable
    a,b,c = float(a),float(b),float(c)  # need to work with float for calculation
