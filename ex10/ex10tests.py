...
defaults = {'modulename':'wikinetwork'}

articledefaults = {'modulename':'article',
...
artcases = {'empty':{'options':{'empty':None},
            ...
            'title':{'options':{'runopts':['get_title',3,ident]},
                   'args':[],
...
networkdefaults = {'runner':network_runner,
                   'fname':None,
                   'args':[],
                }
...
pgrdefaults = {    'runner':network_runner,
                   'fname':'page_rank',
                   'args':[],
                }
...
jacdefaults = {    'runner':network_runner,
                   'fname':'jaccard_index',
                   'args':[],
                }
...
cycdefaults = {    'runner':network_runner,
...
fridefaults = {'runner':network_runner,
...
readdefaults = {'fname':'read_article_links',
                }
