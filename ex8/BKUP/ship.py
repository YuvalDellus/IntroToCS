...
class Ship:
    ...
    def hit(self, pos):
        ...
        :return: True if the bomb generated a new hit in the ship, False
         otherwise.
        """
        # print("pose in hits:",pos in self.hits, "\n","pose in coord:", pos in self.coordinates())
        # print(self.hits)
        if pos in self.coordinates():
            ...
            if hit not in self.__hits:
                ...
                # print("I returend True")
                return True
        # print("I returend False")
        return False
    ...
    def terminated(self):
        ...
        otherwise.
        """
        if len(self.__hits) == self.__length:
            return True
        return False
